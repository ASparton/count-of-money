...
export async function findArticlesByKeywords(keywords: string[]): Promise<Article[]> {
...
export async function createManyArticles(feedId: number, feedArticles: FeedArticle[]) {
